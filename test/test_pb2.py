...
_TEST1 = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='i', full_name='Test1.i', index=8,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='j', full_name='Test1.j', index=9,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='k', full_name='Test1.k', index=10,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='l', full_name='Test1.l', index=11,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='m', full_name='Test1.m', index=12,
